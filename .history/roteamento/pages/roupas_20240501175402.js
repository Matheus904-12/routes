...
export function Roupas() {
  ...
  async function gerarReceita() {
    ...
    const prompt = `Sugira celulares, dicas personalizadas de sobre o dispositivo pesquisado com base na ${ocasiao} e preferencias de configuração: ${ingr1}, ${ingr2}, ${ingr3} e ${ingr4} e pesquise lojas onlines e avaliações sobre o . Caso encontre, informe o link.`;
