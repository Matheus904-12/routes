...
export function Aparelho() {
  ...
  async function gerarReceita() {
    ...
    const prompt = `Sugira celulares, dicas personalizadas de sobre o modelo pesquisado com base na ${ocasiao} e preferencias de configuração: ${ingr1} e ${ingr2}, e pesquise lojas onlines e avaliações sobre o que celular entrega. Caso encontre vídeos no youtube, informe o link.`;
