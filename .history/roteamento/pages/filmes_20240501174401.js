...
export function Filmes() {
    ...
    async function gerarReceita() {
        ...
        const prompt = `Sugira livros com titulos populares e bem avalidados com essas especiicações: ${ingr1}, ${ingr2}, ${ingr3} e ${ingr4}, além de mostrar serviços de streaming e pesquise o trailer no YouTube. Caso encontre, informe o link.`;
