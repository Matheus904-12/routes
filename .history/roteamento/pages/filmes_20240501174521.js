...
export function Filmes() {
    ...
    async function gerarReceita() {
        ...
        const prompt = `Sugira livros com titulos populares e bem avalidados com essas especiicações: ${ingr1}, ${ingr2}, ${ingr3} e ${ingr4}, além de mostrar serviços que contém esses livros e pesquise sobre algum video  no YouTube. Caso encontre, informe o link.`;
