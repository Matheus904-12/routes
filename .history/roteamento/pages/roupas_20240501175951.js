...
export function Roupas() {
  ...
  async function gerarReceita() {
    ...
    const prompt = `Sugira celulares, dicas personalizadas de sobre o dispositivo pesquisado com base na ${ocasiao} e preferencias de configuração: ${ingr1} e ${ingr2}, e pesquise lojas onlines e avaliações sobre o que celular entrega. Caso encontre vídeos no youtube, informe o link.`;
  ...
  return (
    <ScrollView>
      ...
      <Text style={ESTILOS.header}>Qual Celular Comprar?</Text>
      ...
      <TouchableOpacity style={ESTILOS.button} onPress={gerarReceita}>
        <Text style={ESTILOS.buttonText}>Gerar aparelho</Text>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 24, marginTop: 4, }} style={ESTILOS.containerScroll} showsVerticalScrollIndicator={false} >
        {load && (
          <View style={ESTILOS.content}>
            <Text style={ESTILOS.title}>Procurando Aparelho...</Text>
        ...
        {receita && (
          <View style={ESTILOS.content}>
            <Text style={ESTILOS.title}>Modelo ideal aqui 👇</Text>
