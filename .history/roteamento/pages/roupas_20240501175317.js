...
export function Roupas() {
  ...
  async function gerarReceita() {
    ...
    const prompt = `Sugira celulares, dicas personalizadas de sobre o dispositivo pesquisado com base na ${ocasiao} e preferencias de configuração: ${ingr1}, ${ingr2}, ${ingr3} e ${ingr4} e pesquise lojas onlines e aplicativos de modas para os itens recomendados. Caso encontre, informe o link.`;
